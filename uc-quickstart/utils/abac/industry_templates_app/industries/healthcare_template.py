...
-- =============================================
-- POLICY 1: Patient ID Masking for Cross-Table Analytics (Catalog Level)
-- =============================================
...
COLUMN MASK {CATALOG}.{SCHEMA}.mask_referential
TO `users`
FOR TABLES
...
-- =============================================
-- POLICY 2: Business Hours Access for Lab Data (Catalog Level)
-- =============================================
...
-- =============================================
-- POLICY 3: Partial Name Masking for Privacy (Catalog Level)
-- =============================================
...
COLUMN MASK {CATALOG}.{SCHEMA}.mask_name_partial
TO `users`
FOR TABLES
...
-- =============================================
-- POLICY 4: Email Masking (Catalog Level)
-- =============================================
...
-- =============================================
-- POLICY 5: Phone Number Masking (Catalog Level)
-- =============================================
...
-- =============================================
-- POLICY 6: Insurance Number Masking (Last 4) (Catalog Level)
-- =============================================
...
COLUMN MASK {CATALOG}.{SCHEMA}.mask_insurance_last4
TO `users`
FOR TABLES
...
-- =============================================
-- POLICY 7: Age Group Masking for Research (Catalog Level)
-- =============================================
...
COLUMN MASK {CATALOG}.{SCHEMA}.mask_dob_age_group
TO `users`
FOR TABLES
