...
SELECT ssn AS orig, apscat.insurance.mask_ssn_last4(ssn) AS masked FROM policyholders;
SELECT '=== CLAIM BUCKETING ===' AS sec;
SELECT claim_amount AS orig, apscat.insurance.mask_claim_amount_bucket(claim_amount) AS bucket FROM claims;
